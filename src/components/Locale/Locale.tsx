...
// TODO: Looks like localNames is never used
...
const LocaleProvider: React.FC<LocaleProviderProps> = (props) => {
  ...
  const [locale] = React.useState<Locale>(() =>
    // Use Locale set in Browser or EN as a fallback
    localeData[navigator.language] ? (navigator.language as Locale) : Locale.EN
  );
