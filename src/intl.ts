...
export const commonMessages = defineMessages({
  ...
  pleaseEnsureAllRequiredFieldsAreEntered: {
    defaultMessage: "Please ensure all required fields are entered",
  },
  continue: {
...
export const checkoutMessages = defineMessages({
  ...
  areYouSureYouWantToExitCheckout: {
    defaultMessage: "Are you sure you want to exit checkout?",
  },
  stayInCheckout: {
  ...
  stateProvinceArea: {
    defaultMessage: "State/Province/Area",
  },
  zipPostalCode: {
  ...
  backToInformation: {
    defaultMessage: "Back to information",
  },
  paymentInformation: {
