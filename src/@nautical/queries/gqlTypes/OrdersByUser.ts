...
export interface NauticalOrdersByUser_me_nauticalOrders_edges_node_lines {
...
export interface NauticalOrdersByUser_me_nauticalOrders_edges_node {
   ...
   * List of order lines.
   */
  lines: (NauticalOrdersByUser_me_nauticalOrders_edges_node_lines | null)[];
}
...
export interface NauticalOrdersByUser_me_nauticalOrders_edges {
  __typename: "OrderCountableEdge";
  /**
   * The item at the end of the edge.
   */
  node: NauticalOrdersByUser_me_nauticalOrders_edges_node;
}
...
export interface NauticalOrdersByUser_me_orders {
  __typename: "NauticalOrderCountableConnection";
  /**
   * Pagination data for this connection.
   */
  pageInfo: OrdersByUser_me_orders_pageInfo;
  edges: NauticalOrdersByUser_me_nauticalOrders_edges[];
}
...
export interface NauticalOrdersByUser_me {
  __typename: "User";
  /**
   * The ID of the object.
   */
   ...
   * List of user's orders.
   */
  nauticalOrders: NauticalOrdersByUser_me_orders | null;
}
...
export interface NauticalOrdersByUser {
  /**
   * Return the currently authenticated user.
   */
  me: NauticalOrdersByUser_me | null;
}
